...
namespace FarmervsZombies.Managers
{
    ...
    internal static class AnimationManager
    {
        ...
        public static Animation NecromancerAttackDown => new Animation(TextureManager.GetTexture("necromancer_big_attack", 192, 64, 0), 32, 64, 0, -1, 0.2f);

        public static Animation NecromancerAttackUp => new Animation(TextureManager.GetTexture("necromancer_big_attack", 192, 64, 1), 32, 64, 0, -1, 0.2f);

        public static Animation NecromancerAttackRight => new Animation(TextureManager.GetTexture("necromancer_big_attack", 192, 64, 2), 32, 64, 0, -1, 0.2f);

        public static Animation NecromancerAttackLeft => new Animation(TextureManager.GetTexture("necromancer_big_attack", 192, 64, 3), 32, 64, 0, -1, 0.2f);
