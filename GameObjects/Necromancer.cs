...
namespace FarmervsZombies.GameObjects
{
    internal sealed class Necromancer : Zombie
    {
        ...
        private readonly Animation mAttackUpAnimation;
        private readonly Animation mAttackDownAnimation;
                ...
                false)
        {
            ...
            mAttackLeftAnimation = AnimationManager.GetAnimation(AnimationManager.NecromancerAttackLeft, this);
            mAttackRightAnimation = AnimationManager.GetAnimation(AnimationManager.NecromancerAttackRight, this);
            mAttackUpAnimation = AnimationManager.GetAnimation(AnimationManager.NecromancerAttackUp, this);
            mAttackDownAnimation = AnimationManager.GetAnimation(AnimationManager.NecromancerAttackDown, this);
        ...
        protected override Texture2D GetAttackTexture()
        {
            switch (mDirection)
            {
                case 0:
                    return mAttackUpAnimation.GetTexture();
                case 1:
                    return mAttackRightAnimation.GetTexture();
                case 2:
                    return mAttackDownAnimation.GetTexture();
                case 3:
                    return mAttackLeftAnimation.GetTexture();
                default:
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (mIsCasting)
            {
                ...
                {
                    case 0:
                        mTexture = mAttackUpAnimation.GetTexture();
                        break;
                    case 1:
                        mTexture = mAttackRightAnimation.GetTexture();
                        break;
                    case 2:
                        mTexture = mAttackDownAnimation.GetTexture();
                        break;
                    case 3:
                        mTexture = mAttackLeftAnimation.GetTexture();
                        break;
                }
        ...
        public override void Draw(SpriteBatch spriteBatch, Matrix camTransform)
        {
            ...
            if (mTimeSinceCast < 2f)
            {
                ...
                spriteBatch.Draw(texture,
                    new Rectangle((int)((CollisionBoxCenter.X - AbilityRange + Width / 64.0f) * 32),
                        (int)((CollisionBoxCenter.Y - AbilityRange) * 32),
                        (int)AbilityRange * 64,
                        (int)AbilityRange * 64),
                    null,
                    mBackgroundColour,
