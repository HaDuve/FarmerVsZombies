...
namespace FarmervsZombies.GameObjects
{
    internal sealed class Farmer : BMovableGameObject, IAttackable, ICollidable
    {
        ...
        private Animation mCurrentAttackAnimation;
            ...
            DefaultTextureOffsetY)
        {
            ...
            mCurrentAttackAnimation = mAttack2DownAnimation;
        ...
        private void Attack()
        {
            ...
            mDirection = (int) GetDirection(TargetPosition(Target) - CollisionBoxCenter);
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (HasTarget && mCurrentAttackAnimation.AnimationFinished)
            {
                ...
                !mAttack2DownAnimation.AnimationFinished && !mAttack2LeftAnimation.AnimationFinished)
            {
                ...
                {
                    case 0:
                        mCurrentAttackAnimation = mAttack2UpAnimation;
                        break;
                    case 1:
                        mCurrentAttackAnimation = mAttack2RightAnimation;
                        break;
                    case 2:
                        mCurrentAttackAnimation = mAttack2DownAnimation;
                        break;
                    case 3:
                        mCurrentAttackAnimation = mAttack2LeftAnimation;
                        break;
                }
                mTexture = mCurrentAttackAnimation.GetTextureOnce();
                TextureOffset = mCurrentAttackAnimation.TextureOffset;
                Width = mCurrentAttackAnimation.Width;
            }
            else
            {
                mAttack2UpAnimation.AnimationFinished = true;
