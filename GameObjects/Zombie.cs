...
namespace FarmervsZombies.GameObjects
{
    internal class Zombie : BMovableGameObject, IAttackable, ITauntable, ICollidable
    {
        ...
        protected virtual Texture2D GetAttackTexture()
        {
            switch (mDirection)
            {
                case 1:
                    TextureOffset = mAttackRightAnimation.TextureOffset;
                    return mAttackRightAnimation.GetTextureOnce();
                case 3:
                    TextureOffset = mAttackLeftAnimation.TextureOffset;
                    return mAttackLeftAnimation.GetTextureOnce();
                default:
                    return mTexture;
            }
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (HasTarget && mAttackLeftAnimation.AnimationFinished && mAttackRightAnimation.AnimationFinished)
            {
