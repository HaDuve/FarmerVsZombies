...
namespace FarmervsZombies
{
    internal sealed class Statistics
    {
        ...
        {
            if (Game1.TechDemoActive) return;
            if (count < AnimalsAlive)
            {
                Game1.sAchievements.AnimalsDied = true;
            }
            AnimalsAlive = count;
            if (AnimalsAlive == 20 && !Game1.sAchievements.WahrerFarmer && !Game1.TechDemoActive)
            {
        ...
        public void IncreaseAnimals()
        {
            if (Game1.TechDemoActive) return;
            Animals += 1;
            if (!Game1.sAchievements.ErsteGeburt && !Game1.TechDemoActive)
            {
        ...
        public void IncreaseZombiesKilled()
        {
            ...
            ZombiesKilled += 1;
            ZombiesKilledRound++;
            if (ZombiesKilled == 5 && !Game1.sAchievements.DerAnfangVomEnde && !Game1.TechDemoActive)
            {
            ...
            else if (ZombiesKilled == 50 && !Game1.sAchievements.VomGejagtenZumJäger && !Game1.TechDemoActive)
            {
        ...
        public void Win()
        {
            if (Game1.TechDemoActive) return;
            GameWon++;
            if (!Game1.sAchievements.DieApokalypseIstVorbei && !Game1.TechDemoActive)
            {
            ...
            if (!Game1.sAchievements.AnimalsDied && !Game1.sAchievements.SieHattenKeineChance && !Game1.TechDemoActive)
            {
