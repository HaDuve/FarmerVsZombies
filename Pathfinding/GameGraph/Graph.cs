...
namespace FarmervsZombies.Pathfinding.GameGraph
{
    internal sealed class Graph
    {
        ...
        private void ConnectNodes(Vertex v1, Vertex v2, bool unidirectional)
        {
            ...
            var collisionValue1 = (int) v1.Position.X >= 0 && (int) v1.Position.X < mWidth &&
                                  (int) v1.Position.Y >= 0 && (int) v1.Position.Y < mHeight &&
                                  mVerticesTile[(int) v1.Position.X, (int) v1.Position.Y] == v1
                ? mVerticesTileCollision[(int) v1.Position.X, (int) v1.Position.Y]
                : 0;
            var collisionValue2 = (int)v2.Position.X >= 0 && (int)v2.Position.X < mWidth &&
                                  (int)v2.Position.Y >= 0 && (int)v2.Position.Y < mHeight && 
                                  mVerticesTile[(int)v2.Position.X, (int)v2.Position.Y] == v2
