...
namespace FarmervsZombies.Menus
{
    internal sealed class AchievementsMenu : Menu
    {
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            mErsteGeburt = new HudElement(new Point(350, mScreenHeight / 12), new Point(150, 30));
            mWahrerFarmer = new HudElement(new Point(350, 2 * mScreenHeight / 12), new Point(150, 30));
            mFarmingSimulator = new HudElement(new Point(350, 3 * mScreenHeight / 12), new Point(150, 30));
            mDerAnfangVomEnde = new HudElement(new Point(350, 4 * mScreenHeight / 12), new Point(150, 30));
            mVomGejagtenZumJäger = new HudElement(new Point(350, 5 * mScreenHeight / 12), new Point(150, 30));
            mGehirnlos = new HudElement(new Point(350, 6 * mScreenHeight / 12), new Point(150, 30));
            mObdachlos = new HudElement(new Point(350, 7 * mScreenHeight / 12), new Point(150, 30));
            mDasWarErstDerAnfang = new HudElement(new Point(350, 8 * mScreenHeight / 12), new Point(150, 30));
            mDieLangeNacht = new HudElement(new Point(350, 9 * mScreenHeight / 12), new Point(150, 30));
            mDieApokalypseIstVorbei = new HudElement(new Point(350, 10 * mScreenHeight / 12), new Point(150, 30));
            mSieHattenKeineChance = new HudElement(new Point(350, 11 * mScreenHeight / 12), new Point(150, 30));
        ...
        public void UpdateButtons()
        {
            ...
            mErsteGeburt.SetPosition(new Point(350, mScreenHeight / 12));
            mWahrerFarmer.SetPosition(new Point(350, 2 * mScreenHeight / 12));
            mFarmingSimulator.SetPosition(new Point(350, 3 * mScreenHeight / 12));
            mDerAnfangVomEnde.SetPosition(new Point(350, 4 * mScreenHeight / 12));
            mVomGejagtenZumJäger.SetPosition(new Point(350, 5 * mScreenHeight / 12));
            mGehirnlos.SetPosition(new Point(350, 6 * mScreenHeight / 12));
            mObdachlos.SetPosition(new Point(350, 7 * mScreenHeight / 12));
            mDasWarErstDerAnfang.SetPosition(new Point(350, 8 * mScreenHeight / 12));
            mDieLangeNacht.SetPosition(new Point(350, 9 * mScreenHeight / 12));
            mDieApokalypseIstVorbei.SetPosition(new Point(350, 10 * mScreenHeight / 12));
            mSieHattenKeineChance.SetPosition(new Point(350, 11 * mScreenHeight / 12));
        }
