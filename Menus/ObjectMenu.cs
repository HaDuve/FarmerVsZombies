    ...
    internal sealed class ObjectMenu : ActionMenu
    {
        ...
        private List<ActionMenuButton> GetButtons()
        {
            ...
            if (mObject is Farmhouse)
            {
                ...
                if(Game1.CheatMode) result.Add(new ActionMenuButton(mWorldPosition, TextureManager.GetTexture("icons", 32, 32, 10), CheatGold, "Umsatzsteuer-Karussel fahren (Profit: " + EconomyManager.Instance.GetProfit("CheatGold") + " Gold)"));
            }
            ...
            if (mObject is Tree)
            {
                if (Game1.CheatMode) result.Add(new ActionMenuButton(mWorldPosition, TextureManager.GetTexture("icons", 32, 32, 28), ActionRemoveTree, "Baum fällen"));
        ...
        private void ActionDestroyFarmhouse()
        {
            ...
            if (!Game1.sAchievements.Obdachlos && !Game1.TechDemoActive)
            {
