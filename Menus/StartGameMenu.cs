...
namespace FarmervsZombies.Menus
{
    internal sealed class StartGameMenu : Menu
    {
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            mStartNewGame = new MenuButton(new Point(mScreenWidth / 2 - 100, mScreenHeight / 5 - 95), 75, 200, "Neues Spiel", txtposX: 5);

            mLoadGame = new MenuButton(new Point(mScreenWidth / 2 - 75, mScreenHeight / 5 - 95 + ButtonDistance), 75, 150, "Spiel laden");

            mTechDemo = new MenuButton(new Point(mScreenWidth / 2 - 100, mScreenHeight / 5 - 95 + 2 * ButtonDistance), 75, 200, "Tech Demo starten");
        ...
        public void UpdateButtons()
        {
            ...
            mStartNewGame.SetPosition(new Point((mScreenWidth / 2) - 100, (mScreenHeight / 5) - 95));
            mLoadGame.SetPosition(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + ButtonDistance));
            mTechDemo.SetPosition(new Point((mScreenWidth / 2) - 100, (mScreenHeight / 5) - 95 + 2 * ButtonDistance));
        }
