...
namespace FarmervsZombies.Menus
{
    internal sealed class MainMenu : Menu
    {
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            mStart = new MenuButton(new Point((mScreenWidth / 2) - 100, (mScreenHeight / 5) - 95), 75, 200, "Spiel Starten", 5);

            // Drawing button for statistics menu
            mStatistics = new MenuButton(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + ButtonDistance), 75, 150, "Statistiken", 6);
            mAchievements = new MenuButton(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + 2 * ButtonDistance), 75, 150, "Achievements");

            mOptions = new MenuButton(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + 3 * ButtonDistance), 75, 150, "Optionen", 5);

            mExit = new MenuButton(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + 4 * ButtonDistance), 75, 150, "Beenden", 5);
        ...
        public void UpdateButtons()
        {
            ...
            mStart.SetPosition(new Point((mScreenWidth / 2) - 100, (mScreenHeight / 5) - 95));

            mStatistics.SetPosition(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + ButtonDistance));
            mAchievements.SetPosition(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + 2 * ButtonDistance));

            mOptions.SetPosition(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + 3 * ButtonDistance));

            mExit.SetPosition(new Point((mScreenWidth / 2) - 75, (mScreenHeight / 5) - 95 + 4 * ButtonDistance));
        }
