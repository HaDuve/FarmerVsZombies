...
namespace FarmervsZombies.AI
{
    internal static class Ai
    {
        ...
        {
            sResources += gameTime.ElapsedGameTime.TotalMilliseconds * Math.Sqrt(Game1.mTime / 60) * Game1.Difficulty;
            ...
            foreach (var wave in sWaves)
            {
                ...
                if (!IsWaveBusy(wave))
                {
                    SetWaveTactic(wave, Game1.mTime / 60);
                }
            }
            ...
            else if (10 + 2 * Game1.mTime / 60 <= sAvailableSpawns)
            {
                SpawnWave(10 + 2 * (int)(Game1.mTime / 60), Game1.mTime / 60);
            }
